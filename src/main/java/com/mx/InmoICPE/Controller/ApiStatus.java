...
import com.mx.InmoICPE.Service.ImpStatus;
...
public class ApiStatus {
	...
	@PostMapping
	public ResponseEntity<Status> create(@RequestBody Status body){
		body = (Status) imp.guardar(body);
		if (body != null) {
	...
	public ResponseEntity<Status> update(@PathVariable Integer id, @RequestBody Status body){
		Status found = (Status) imp.buscar(id);
		if (found != null) {
